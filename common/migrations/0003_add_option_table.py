...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('common_option', (
            ('id', models.AutoField(primary_key=True)),
            ('site', models.ForeignKey(orm['sites.Site'], unique=True)),
            ('theme', models.ForeignKey(orm['common.Theme'])),
        ))
        db.send_create_signal('common', ['Option'])

    def backwards(self, orm):
        "Write your backwards migration here"

        # Deleting model 'Option'
        db.delete_table('common_option')
    ...
    models = {
        ...
        'common.option': {
            ...
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.Theme']"})
        },
        'common.shirtsize': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        ...
        'common.theme': {
            ...
            'selected': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        'common.userprofile': {
