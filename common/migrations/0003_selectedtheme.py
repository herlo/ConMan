...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('common_theme', (
            ...
            ('name', orm['common.theme:name']),
            ('description', orm['common.theme:description']),
            ('slug', orm['common.theme:slug']),
    ...
    models = {
        ...
        'common.selectedtheme': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'selected': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.Theme']"})
        },
        'common.shirtsize': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
